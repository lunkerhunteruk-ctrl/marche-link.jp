            ...
            <div className="border-t border-gray-200 px-2 py-2">
              <div className="flex items-center gap-2">
                <input
                  ...
                  value={inputValue}
                  readOnly
                  className="flex-1 min-w-0 max-w-[140px] px-2 py-1 text-sm border border-gray-300 rounded bg-gray-50"
                />
                <button
                  type="button"
                  onClick={handleAddNew}
                  disabled={isAdding}
                  className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-amber-500 text-white rounded hover:bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isAdding ? (
